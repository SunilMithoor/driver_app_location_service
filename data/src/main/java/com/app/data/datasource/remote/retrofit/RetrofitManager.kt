...
import com.app.data.BuildConfig.VERSION_CODE
import com.app.data.BuildConfig.VERSION_NAME
import com.app.domain.entity.response.base.Success
import com.app.domain.entity.wrapped.Event
import com.app.domain.extention.G
...
class RetrofitManager(
    ...
    private inner class RefreshToken : Interceptor {
        override fun intercept(chain: Interceptor.Chain): Response {
            ...
            Timber.d("Api message-->${response.message}")
            return response
        }
