package com.app.services.firebase
...
class FirebaseService : FirebaseMessagingService() {
    ...
    private val CHANNEL_ID = "Channel_App"
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            .setSmallIcon(AppDrawable.ic_launcher_notification)
            .setLargeIcon(BitmapFactory.decodeResource(resources, AppMipmap.ic_launcher_icon_round))
