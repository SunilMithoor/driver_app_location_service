...
import com.app.R
import com.app.domain.extention.toCamelCase
...
var View.backgroundTint: Int
    ...
    set(value) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (background != null) {
                when (this) {
                    is AppCompatAutoCompleteTextView -> supportBackgroundTintList =
                        context.resColorStateList(value)
                    is AppCompatTextView -> supportBackgroundTintList =
                        context.resColorStateList(value)
                    is AppCompatButton -> supportBackgroundTintList =
                        context.resColorStateList(value)
                    is AppCompatImageView -> supportBackgroundTintList =
                        context.resColorStateList(value)
                    is AppCompatMultiAutoCompleteTextView -> supportBackgroundTintList =
                        context.resColorStateList(value)
                    is AppCompatEditText -> supportBackgroundTintList =
                        context.resColorStateList(value)
                    is AppCompatImageButton -> supportBackgroundTintList =
                        context.resColorStateList(value)
                    is AppCompatSpinner -> supportBackgroundTintList =
                        context.resColorStateList(value)
...
fun TextView.bold() {
    typeface = ResourcesCompat.getFont(context, R.font.open_sans_condensed_bold)
}

fun TextView.normal() {
    typeface = ResourcesCompat.getFont(context, R.font.open_sans_condensed_medium)
}

fun TextView.semiBold() {
    typeface = ResourcesCompat.getFont(context, R.font.open_sans_condensed_semi_bold)
}
...
fun AppCompatActivity.setSupportActionBarTitle(data: Int) {
    supportActionBar?.title = getString(data)
}

fun AppCompatActivity.setSupportActionBarTitleData(data: String) {
