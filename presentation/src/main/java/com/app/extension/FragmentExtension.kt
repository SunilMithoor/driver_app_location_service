...
fun Fragment.resString(@StringRes stringRes: Int) =
...
fun Fragment.resBoolean(@BoolRes boolRes: Int) =
    this.context?.resBoolean(boolRes)

fun Fragment.resIntArray(@ArrayRes intArrRes: Int) =
    this.context?.resIntArray(intArrRes)

fun Fragment.resStrArray(@ArrayRes strArrRes: Int) =
...
inline fun <reified T : Any> Fragment.extra(key: String, default: T) = lazy {
