...
internal class FireBaseApiWrapper : FireBaseApiWrapperInterface {
     ...
     */
    override fun childEventListener(
    ...
    override fun valueEventListener(
        mDatabaseReference: DatabaseReference,
     ...
     */
    override fun singleValueEventListener(
        mDatabaseReference: DatabaseReference,
        singleValueEventListener: ValueEventListener?
    ) {
    ...
    override fun createNewUserWithEmailPassword(
        userEmail: String?,
        password: String?,
    ...
    override fun listenToDynamicLinks(
        intent: Intent?,
        context: Context?,
        onSuccessListener: OnSuccessListener<PendingDynamicLinkData?>?,
        onFailureListener: OnFailureListener?
    ) {
    ...
    override fun reloadCurrentUserAuthState(
